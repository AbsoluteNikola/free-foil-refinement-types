...
alex_base = Data.Array.listArray (0 :: Int, 21)
  [ -8
  , 91
  , 92
  , 245
...
alex_table = Data.Array.listArray (0 :: Int, 860)
  [ 0
  , 12
  , 12
  , 12
...
alex_check = Data.Array.listArray (0 :: Int, 860)
  [ -1
  , 9
  , 10
  , 11
...
alex_deflt = Data.Array.listArray (0 :: Int, 21)
  [ -1
  , -1
  , -1
  , -1
...
alex_accept = Data.Array.listArray (0 :: Int, 21)
  [ AlexAccNone
  , AlexAcc 10
  , AlexAccNone
  , AlexAcc 9
  ...
  b ">=" 21
    ...
    (b "rec" 31
       (b "else" 26
          ...
          (b "int" 29 (b "if" 28 (b "false" 27 N N) N) (b "let" 30 N N)))
       (b "{" 36
          (b "true" 34 (b "t(" 33 (b "switch" 32 N N) N) (b "type" 35 N N))
          (b "}" 39 (b "||" 38 (b "|" 37 N N) N) (b "\8704" 40 N N))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
