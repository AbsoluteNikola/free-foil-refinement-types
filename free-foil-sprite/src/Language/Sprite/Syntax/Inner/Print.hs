...
instance Print Language.Sprite.Syntax.Inner.Abs.Term where
  prt i = \case
    ...
    Language.Sprite.Syntax.Inner.Abs.CaseAlt varident pattern_ scopedterm -> prPrec i 0 (concatD [doc (showString "|"), prt 0 varident, doc (showString ":"), doc (showString "("), prt 0 pattern_, doc (showString ")"), doc (showString "=>"), prt 0 scopedterm])
