...
instance Print Language.Sprite.Syntax.Inner.Abs.Term where
  prt i = \case
    ...
    Language.Sprite.Syntax.Inner.Abs.CaseAlt conident pattern_ scopedterm -> prPrec i 0 (concatD [doc (showString "|"), prt 0 conident, doc (showString ":"), doc (showString "("), prt 0 pattern_, doc (showString ")"), doc (showString "=>"), prt 0 scopedterm])
