...
alex_table = Data.Array.listArray (0 :: Int, 626)
  [ 0
  , 6
  , 6
  , 6
...
alex_check = Data.Array.listArray (0 :: Int, 626)
  [ -1
  , 9
  , 10
  , 11
...
resWords =
  b ">=" 19
    ...
    (b "int" 28
       (b "bool" 24
          (b "]" 22 (b "[" 21 (b "?" 20 N N) N) (b "_" 23 N N))
          (b "false" 26 (b "else" 25 N N) (b "if" 27 N N)))
       (b "val" 33
          (b "rec" 31 (b "qualif" 30 (b "let" 29 N N) N) (b "true" 32 N N))
